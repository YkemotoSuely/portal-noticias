...
class NoticiaController extends Controller
{
    ...
    /**
     * Mostrar formula´rio para cadastrar notícia
     */
    public function create()
    {
        $categorias = Categoria::orderBy('nome', 'ASC')->pluck('nome','id');
        
        //comando para testar se as categorias estão sendo carregadas: dd($categorias);
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'imagem' =>'required|image|mimes:jpg,png,jpg,webp|max:2048'
